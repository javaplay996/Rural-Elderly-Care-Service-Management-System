    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="laorenId" name="laorenId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="健康档案名称" prop="jiankangName">
                       <el-input v-model="ruleForm.jiankangName"
                                 placeholder="健康档案名称" clearable  :readonly="ro.jiankangName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="健康档案名称" prop="jiankangName">
                           <el-input v-model="ruleForm.jiankangName"
                                     placeholder="健康档案名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="健康档案编号" prop="jiankangUuidNumber">
                       <el-input v-model="ruleForm.jiankangUuidNumber"
                                 placeholder="健康档案编号" clearable  :readonly="ro.jiankangUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="健康档案编号" prop="jiankangUuidNumber">
                           <el-input v-model="ruleForm.jiankangUuidNumber"
                                     placeholder="健康档案编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.jiankangPhoto" label="健康档案照片" prop="jiankangPhoto">
                        <file-upload
                            tip="点击上传健康档案照片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiankangPhoto" label="健康档案照片" prop="jiankangPhoto">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="健康档案地点" prop="jiankangAddress">
                       <el-input v-model="ruleForm.jiankangAddress"
                                 placeholder="健康档案地点" clearable  :readonly="ro.jiankangAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="健康档案地点" prop="jiankangAddress">
                           <el-input v-model="ruleForm.jiankangAddress"
                                     placeholder="健康档案地点" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="身体情况" prop="jiankangTypes">
                        <el-select v-model="ruleForm.jiankangTypes" :disabled="ro.jiankangTypes" placeholder="请选择身体情况">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="身体情况" prop="jiankangValue">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="注意事项" prop="jiankangContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jiankangContent" label="注意事项" prop="jiankangContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   jiankangName: [
                              { required: true, message: '健康档案名称不能为空', trigger: 'blur' },
                          ],
                   jiankangUuidNumber: [
                              { required: true, message: '健康档案编号不能为空', trigger: 'blur' },
                          ],
                   jiankangPhoto: [
                              { required: true, message: '健康档案照片不能为空', trigger: 'blur' },
                          ],
                   jiankangAddress: [
                              { required: true, message: '健康档案地点不能为空', trigger: 'blur' },
                          ],
                   jiankangTypes: [
