               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="医疗人员名称" prop="yiliaoName">
                       <el-input v-model="ruleForm.yiliaoName"
                                 placeholder="医疗人员名称" clearable  :readonly="ro.yiliaoName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="yiliaoPhone">
                       <el-input v-model="ruleForm.yiliaoPhone"
                                 placeholder="联系方式" clearable  :readonly="ro.yiliaoPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="邮箱" prop="yiliaoEmail">
                       <el-input v-model="ruleForm.yiliaoEmail"
                                 placeholder="邮箱" clearable  :readonly="ro.yiliaoEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="医疗人员介绍" prop="yiliaoContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yiliaoContent" label="医疗人员介绍" prop="yiliaoContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yiliaoName: [
                              { required: true, message: '医疗人员名称不能为空', trigger: 'blur' },
                          ],
                   yiliaoPhone: [
                   ...
                   yiliaoContent: [
                              { required: true, message: '医疗人员介绍不能为空', trigger: 'blur' },
                          ],
                   yiliaoDelete: [
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.yiliaoContent = _this.ruleForm.yiliaoContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.yiliaoContent = this.ruleForm.yiliaoContent.replaceAll(this.$base.url,"");
                        this.$http({
