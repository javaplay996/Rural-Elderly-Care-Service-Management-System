        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '文娱活动名称' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.huodongName" placeholder="文娱活动名称" clearable></el-input>
                     </el-form-item>
                                 
                     <el-form-item :label="contents.inputTitle == 1 ? '文娱活动类型' : ''">
                        <el-select v-model="searchForm.huodongTypes" placeholder="请选择文娱活动类型">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xylfwglxt/upload/huodongMuBan.xls"
                        >批量导入文娱活动数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('huodong','导入导出')"
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                ...
                //本表字段
                     '文娱活动名称': "huodongName",
                     '文娱活动编号': "huodongUuidNumber",
                     '文娱活动照片': "huodongPhoto",
                     '文娱活动地点': "huodongAddress",
                     '文娱活动类型': "huodongValue",
                     '录入时间': "insertTime",
            },
