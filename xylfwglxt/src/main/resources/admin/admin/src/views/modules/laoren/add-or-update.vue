        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="老人名称" prop="laorenName">
                       <el-input v-model="ruleForm.laorenName"
                                 placeholder="老人名称" clearable  :readonly="ro.laorenName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="laorenPhone">
                       <el-input v-model="ruleForm.laorenPhone"
                                 placeholder="联系方式" clearable  :readonly="ro.laorenPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="邮箱" prop="laorenEmail">
                       <el-input v-model="ruleForm.laorenEmail"
                                 placeholder="邮箱" clearable  :readonly="ro.laorenEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="老人介绍" prop="laorenContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.laorenContent" label="老人介绍" prop="laorenContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   laorenContent: [
                              { required: true, message: '老人介绍不能为空', trigger: 'blur' },
                          ],
                   laorenDelete: [
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.laorenContent = _this.ruleForm.laorenContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.laorenContent = this.ruleForm.laorenContent.replaceAll(this.$base.url,"");
                        this.$http({
