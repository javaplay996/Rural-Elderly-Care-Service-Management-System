        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='huodong'">
                    <el-form-item class="select" v-if="type!='info'"  label="文娱活动" prop="huodongId">
                        <el-select v-model="ruleForm.huodongId" :disabled="ro.huodongId" filterable placeholder="请选择文娱活动" @change="huodongChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="文娱活动名称" prop="huodongName">
                        <el-input v-model="huodongForm.huodongName"
                                  placeholder="文娱活动名称" clearable readonly></el-input>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="文娱活动编号" prop="huodongUuidNumber">
                        <el-input v-model="huodongForm.huodongUuidNumber"
                                  placeholder="文娱活动编号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="文娱活动地点" prop="huodongAddress">
                        <el-input v-model="huodongForm.huodongAddress"
                                  placeholder="文娱活动地点" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="文娱活动类型" prop="huodongValue">
                        <el-input v-model="huodongForm.huodongValue"
                                  placeholder="文娱活动类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
