...
*/
@TableName("baojian")
public class BaojianView extends BaojianEntity implements Serializable {
	...
	* 医疗保健类型的值
	*/
	@ColumnInfo(comment="医疗保健类型的字典表值",type="varchar(200)")
	private String baojianValue;
	...
	public BaojianView(BaojianEntity baojianEntity) {
		try {
			BeanUtils.copyProperties(this, baojianEntity);
	...
	* 获取： 医疗保健类型的值
	*/
	public String getBaojianValue() {
		return baojianValue;
	}
	/**
	* 设置： 医疗保健类型的值
	*/
	public void setBaojianValue(String baojianValue) {
		this.baojianValue = baojianValue;
	}
