                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            HuodongEntity huodongEntity = new HuodongEntity();
//                            huodongEntity.setHuodongName(data.get(0));                    //文娱活动名称 要改的
//                            huodongEntity.setHuodongUuidNumber(data.get(0));                    //文娱活动编号 要改的
//                            huodongEntity.setHuodongPhoto("");//详情和图片
//                            huodongEntity.setHuodongAddress(data.get(0));                    //文娱活动地点 要改的
//                            huodongEntity.setHuodongTypes(Integer.valueOf(data.get(0)));   //文娱活动类型 要改的
...
//                            huodongEntity.setCreateTime(date);//时间
                        ...
                        if(huodongEntities_huodongUuidNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [文娱活动编号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
