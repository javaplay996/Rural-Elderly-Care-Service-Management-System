...
//                            yonghuEntity.setYonghuName(data.get(0));                    //志愿者姓名 要改的
//                            yonghuEntity.setYonghuPhone(data.get(0));                    //志愿者手机号 要改的
//                            yonghuEntity.setYonghuIdNumber(data.get(0));                    //志愿者身份证号 要改的
...
//                            yonghuEntity.setYonghuEmail(data.get(0));                    //志愿者邮箱 要改的
//                            yonghuEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(yonghu.getId(),username, "yonghu", "乡村志愿者");
        R r = R.ok();
        r.put("token", token);
        r.put("role","乡村志愿者");
